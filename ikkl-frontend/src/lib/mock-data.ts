...
export const MOCK_MATCHES: Match[] = [
  {
    ...
    dateStr: "March 28", time: "2:00 PM", venue: "Ground A", status: "COMPLETED",
    scoreA: 34, scoreB: 28,
  ...
  },
  {
    ...
    dateStr: "March 28", time: "4:30 PM", venue: "Ground B", status: "COMPLETED",
    scoreA: 41, scoreB: 35,
  ...
  { id: "m9", teamA: TEAMS.NIG, teamB: TEAMS.THU, dateStr: "April 1", time: "11:00 AM", venue: "Ground A", status: "UPCOMING" },
  { id: "m10", teamA: TEAMS.BLA, teamB: TEAMS.PHO, dateStr: "April 1", time: "3:00 PM", venue: "Ground B", status: "UPCOMING" },
  { id: "m11", teamA: TEAMS.VEL, teamB: TEAMS.CYC, dateStr: "April 2", time: "11:00 AM", venue: "Ground A", status: "UPCOMING" },
  { id: "m12", teamA: TEAMS.STE, teamB: TEAMS.IRO, dateStr: "April 2", time: "3:00 PM", venue: "Ground B", status: "UPCOMING" },
];
